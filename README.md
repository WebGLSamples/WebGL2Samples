...
|[sampler_object](http://webglsamples.org/WebGL2Samples/#sampler_filter)|:x:not tested|:white_check_mark:| :x: not tested|:white_check_mark:|
|[sampler_wrap](http://webglsamples.org/WebGL2Samples/#sampler_filter)|:x:not tested|:white_check_mark:| :x: not tested|:white_check_mark:|
